    ...
    return(
        <footer className={styles.footer}>
            <Row className="d-flex justify-content-evenly ml-5">
                <Col md={1} xs={12} className={styles.link}>
                ...
                <Col md={1} xs={12} className={styles.link}>
                    <a href="https://www.malt.fr/profile/jeremyquerne?q=developpeur" target="_blank" rel="noopener noreferrer">
                        <IoShareSocial size={36} className={styles.icons} id="shakeanimation"/>
                        Malt
                    </a>
                </Col>
            </Row>
